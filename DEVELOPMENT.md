...
```bash
git remote add encore encore://free-beer-studio-ai-platform-nyvi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/free-beer-studio-ai-platform-nyvi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/free-beer-studio-ai-platform-nyvi/settings/integrations/github)
