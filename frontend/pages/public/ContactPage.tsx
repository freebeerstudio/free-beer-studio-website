          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              <Card className="bg-rocket-gray/10 border-rocket-gray/20">
                <CardHeader>
                  <CardTitle className="text-2xl text-cloud-white font-['Architects_Daughter']">
                    Send us a message
                  </CardTitle>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        <label className="text-sm font-medium text-cloud-white">
                          Name *
                        </label>
                        <Input
                    ...
                    <div className="space-y-2">
                      ...
                      <Select value={formData.topic} onValueChange={(value) => handleInputChange('topic', value)}>
                        <SelectTrigger className="bg-jet-black border-rocket-gray text-cloud-white">
                          <SelectValue placeholder="What can we help you with?" />
                        </SelectTrigger>
                        <SelectContent className="bg-jet-black border-rocket-gray">
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        className="bg-jet-black border-rocket-gray text-cloud-white min-h-[120px]"
                        required
                      />
                    </div>
